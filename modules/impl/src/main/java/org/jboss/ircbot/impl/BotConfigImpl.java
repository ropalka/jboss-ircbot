...
public final class BotConfigImpl implements BotConfig {
    ...
    public BotConfigImpl( final String serverAddress, final int serverPort, final Set< String > serverChannels, final String botNick, final String botFullName,
        final String botPassword ) {
