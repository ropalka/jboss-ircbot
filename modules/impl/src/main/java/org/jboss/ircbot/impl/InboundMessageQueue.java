...
/**
 * FIFO queue for incomming IRC messages.
 * 
 * @author <a href="ropalka@redhat.com">Richard Opalka</a>
 */
public final class InboundMessageQueue extends AbstractMessageQueue {

    private static final InboundMessageQueue INSTANCE = new InboundMessageQueue();

    private InboundMessageQueue() {
        // forbidden inheritance
    }

    public static InboundMessageQueue getInstance() {
        return INSTANCE;
    }
}
