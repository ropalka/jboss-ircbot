 ...
 */
public final class PathService extends AbstractService< String > {
    ...
    public static void addService( final ServiceName serviceName, final String fileName, final ServiceTarget serviceTarget ) {
        final PathService service = new PathService( fileName );
