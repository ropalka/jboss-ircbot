 ...
 */
final class JIRAThreadFactory implements ThreadFactory {

    static final ThreadFactory INSTANCE = new JIRAThreadFactory();
    private final AtomicInteger threadNumber = new AtomicInteger( 1 );

    private JIRAThreadFactory() {
    }

    public Thread newThread( final Runnable r ) {
        final Thread t = new Thread( r, "JIRA Bot Service Worker Thread " + threadNumber.getAndIncrement() );
        t.setDaemon( true );
