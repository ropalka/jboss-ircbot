 ...
 */
final class PartMessageLogHandler implements LogHandler
{
    ...
    private static String getDetail(final Message msg)
    {
        ...
        final String channel = getChannel(msg, false);
        final StringBuilder sb = new StringBuilder();
        sb.append(ASTERISK).append(ASTERISK).append(ASTERISK).append(SPACE);
        sb.append(user).append(SPACE).append("has").append(SPACE).append("left");
