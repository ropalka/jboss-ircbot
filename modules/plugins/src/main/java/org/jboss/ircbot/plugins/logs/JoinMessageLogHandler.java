 ...
 */
final class JoinMessageLogHandler implements LogHandler
{

    private static final LogHandler SINGLETON = new JoinMessageLogHandler();

    private JoinMessageLogHandler()
    {
    ...
    public LogMessage getLogMessage(final Message msg)
    {
        ...
        logBuilder.setChannel(getChannel(msg, true));
        logBuilder.setColor(GREEN);
    ...
    private static String getDetail(final Message msg)
    {
        ...
        final String channel = getChannel(msg, true);
        final StringBuilder sb = new StringBuilder();
        sb.append(ASTERISK).append(ASTERISK).append(ASTERISK).append(SPACE);
        sb.append(user).append(SPACE).append("has").append(SPACE).append("joined");
