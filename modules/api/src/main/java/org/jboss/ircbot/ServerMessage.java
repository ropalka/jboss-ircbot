...
/**
 * IRC message received from IRC server.
 * 
...
public interface ServerMessage extends Message {
    ...
    /**
     * Returns IRC reply code of this message or
     * <code>{@link org.jboss.ircbot.ReplyCode#UNKNOWN}</code> if this message
     * doesn't contain IRC reply code.
     * 
     * @return IRC reply code
     */
    ReplyCode getReply();
}
